...
zip_factor = 1; % Zero pad by factor of 4
...
final_image = laplacian_image_alt( sos_image, da_xres, da_yres, zip_factor);

%8: Create DICOM image file from Pfile name
new_dfile = strcat(pfile, "def_lp.dcm");
...
info.WindowWidth  = 20000;  %default window width for new image
info.WindowCenter = 10000;  %defautl window level for new image
info.PatientName.FamilyName = fname;
info.SeriesDescription = 'Laplacian Filtered';
info.ExamNumber = '1';
info.SeriesNumber = 4;
